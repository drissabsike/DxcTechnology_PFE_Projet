             ...
             <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h2 class="card-title">Liste des Projets Annuler</h2>
                </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <c:forEach items="${ListProjets}" var="projet">
                      <tr>
                        ...
                        <td>
                        <a href="Confirmer_Projet?id_projet=${projet.id_projet}" class="btn btn-success">confirmer</a>
                        <a href="show_Justification?id_projet=${projet.id_projet}" class="btn btn-info">Justification</a>
                        </td> 
                       </tr>
                      </c:forEach>
                    </tbody>
