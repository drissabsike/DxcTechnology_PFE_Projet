          ...
          <div class="row">
            <div class="col-md-10">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="/MANAGER/process_EditManager" method="post" enctype="multipart/form-data">
                    <div class="row">
                       <div class="col-md-3">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="titre" value="${user.titre}" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                        <img height="120px" width="120px" style="border-radius: 50%;" src="/${user.image_path}">
                          <label class="bmd-label-floating">${user.nom} ${user.prenom}</label>
                        </div>
                      </div>
                    </div>
                    <input type="submit" class="btn btn-primary pull-right"  value="Modifier Profile"/>	
                 </form>
                </div>
              </div>
            </div>
