             ...
             <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  ...
                  <p class="card-category"><a href="NouvProjet" class="btn btn-success">Crée un Projet</a></p>
                </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <c:forEach items="${ListProjets}" var="projet">
                      <tr>
                        ...
                        <td>
                        <a href="AnnulerProjet?id_projet=${projet.id_projet}" class="btn btn-warning">Annuler</a>
                        <a href="GenererDevis?id_projet=${projet.id_projet}" class="btn btn-info">DEVIS</a>                        
						<a href="NouvTache?id_projet=${projet.id_projet}" class="btn btn-success">Créer des tâches</a>
						<!--<a href="AddTeams?titre_projet=${projet.titre_projet}" class="btn btn-primary">Ajouter des Equipes</a> -->                        
						</td>  
                       </tr>
                      </c:forEach>
                    </tbody>
