    ...
    <div id="page-wrapper">
        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                ...
                <div class="card-body">
                    <form action="/MANAGER/process_create_project" method="POST" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="name">Titre de Projet</div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="titre_projet" required="required">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Budget ?</div>
                            <div class="value">
                                <input class="input--style-6" type="number" name="budget_projet" required="required">
                            </div><br><br><br>
                            <div class="name">Avance ?</div>
                            <div class="value">
                                <input class="input--style-6" type="number" name="avance" required="required">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Cin de Manager</div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="cin_Manager" value="${cin}" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
								<select class="input--style-6" name="client" required="required">
										<option>----Select----</option>
									<% try{
										Class.forName("com.mysql.jdbc.Driver");
										Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/stage?serverTimezone=UTC","root","");
										String req="SELECT nom_client FROM clients";
										PreparedStatement ps = con.prepareStatement(req);
										ResultSet rs = ps.executeQuery();
										while(rs.next()){
											%>
											<option value="<%=rs.getString("nom_client")%>"><%=rs.getString("nom_client")%></option>
											<% 
										}
                        ...
                        <div class="form-row">
                            ...
                            <input id="date" type="date" name="DateDebut" value="2021-06-01">
    					</div>
                        </div>	
                       <div class="form-row">
                            <div class="name">Date fin</div>
                            <div data-role="page" id="home"> 
                            <input id="date" type="date" name="DateFin" value="2021-07-01">
                        </div>
                        </div>
                        <div class="form-row">
                       ...
                       <div class="form-row">
                            <div class="name">Cahier de Charge</div>
                            <div class="value">
                                <div class="input-group js-input-file">
                                    <input class="input-file" type="file" name="file" id="file" required="required">
                                </div> 
                                <div class="label--desc"><strong>Sélectionner le cahier de charge de projet Format .docx (Word). Max file size 50 MB</strong></div>
