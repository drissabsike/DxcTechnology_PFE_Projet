            ...
            <div class="col-md-10">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Annuler le projet</h4>
                </div>
                <div class="card-body">
                  <form action="/MANAGER/process_justification" method="post">
                    <div class="row">
                       <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">ID du Projet</label>
                          <input type="number" name="id_projet" value="${id_projet}" readonly class="form-control">
                        </div>
                      </div>
                      <div class="col-md-3">
                            ...
                            <div class="value" style="width: 800px;">
                                <div class="input-group">
                                    <textarea class="textarea--style-6" name="Justification" placeholder="Justification" required="required"></textarea>
                                </div>
                            </div>
                        </div>
                    </div><br>
