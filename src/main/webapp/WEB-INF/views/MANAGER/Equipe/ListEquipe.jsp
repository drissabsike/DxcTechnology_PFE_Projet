         ...
         <div class="col-lg-10 col-md-12">
              <div class="card">
                <div class="card-header card-header-warning">
                  <h2 class="card-title">Liste des Equipes</h2>
                  <a href="NewTeams" class="btn btn-success">Créé Une Equipe</a>
                </div>
                <div class="card-body table-responsive">
                  <table class="table table-hover">
                    <thead class="thead-dark">
                      	<th>Nom d'equipe</th>
                        <th>Description</th>
                        <th>Date d'creation</th>
                      	<th>Action</th>
                    </thead>
                    <tbody>
                    <c:forEach items="${listE}" var="listE">
                      <tr>
                        <td>${listE.nom_equipe}</td>
                        <td>${listE.description}</td>
                        <td>${listE.date_creation}</td>
                        <td>
                        <a href="AddMember?nom_equipe=${listE.nom_equipe}" class="btn btn-success">Ajouter des Member</a>
                        <a href="ListMemberEquipe?nom_equipe=${listE.nom_equipe}" class="btn btn-info">Membre d'equipe</a>
                        <a href="/Equipe/DeleteTeam?id=${listE.id}" class="btn btn-danger">Supprimer l'équipe</a>
                        </td> 
                       </tr>
                      </c:forEach>
                    </tbody>
