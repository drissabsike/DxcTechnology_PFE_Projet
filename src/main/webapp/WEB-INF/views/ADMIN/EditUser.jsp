        ...
        <div class="wrapper wrapper--w600">
            ...
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Utilisateur ${user.nom} ${user.prenom}</h2>
                </div>
                <div class="card-body" style="margin-right: 450px;">
                    <form action="/ADMIN/process_EditUser?nom2=${nom2}&cin=${user.cin}" method="post">
                        <div class="form-row">
                        	<div class="name">CIN</div>
                            <div class="value">
                                <input class="input--style-6" type="text" value="${user.cin}" name="cin2" placeholder="CIN"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Prenom</div>
                            <div class="value">
                                <input class="input--style-6" type="text" value="${user.prenom}" name="prenom" placeholder="Prenom"/>
                            </div><br><br><br>
                            <div class="name">Nom</div>
                            <div class="value">
                                <input class="input--style-6" type="text" value="${user.nom}" name="nom" placeholder="Nom"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Telephone</div>
                            <div class="value">
                                <input class="input--style-6" type="text" value="${user.telephone}" name="telephone" placeholder="Telephone"/>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Email</div>
                            <div class="value">
                                <input class="input--style-6" type="text" readonly value="${user.email}"  name="email" placeholder="Email" />
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="name">Titre</div>
                            <div class="value">
                                <input class="input--style-6" type="text" value="${user.titre}" name="titre" placeholder="Titre"/>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div data-role="controlgroup" data-type="horizontal" data-inline="true">
                            	<select name="role_user"  class="input--style-6"  id="select-choice-1" data-inline="true">
                                            <option selected="selected">${user.role_user}</option>
                            ...
                            <div class="name">User Experiance</div>
                              <div data-role="controlgroup" data-type="horizontal" data-inline="true">
								<select name="experiance" class="input--style-6"  id="select-choice-1" data-inline="true">
                                            <option selected="selected">${user.experiance}</option>
